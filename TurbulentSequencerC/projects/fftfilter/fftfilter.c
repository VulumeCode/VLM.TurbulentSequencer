...
void ext_main(void* r)
{
	...
	c = class_new("fftfilter", (method)fftfilter_new, (method)fftfilter_free, sizeof(t_fftfilter), 0L, A_DEFLONG, 0);
...
void* fftfilter_new(long dummy)		// dummy = int argument typed into object box (A_DEFLONG) -- defaults to 0 if no args are typed
{
	t_fftfilter* x;
