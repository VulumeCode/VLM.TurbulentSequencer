...
void *rotatePiano_new(long dummy);
...
void ext_main(void* r)
{
	...
	c = class_new("rotatePiano", (method)rotatePiano_new, (method)rotatePiano_free, sizeof(t_rotatePiano), 0L, A_DEFLONG, 0);
...
void* rotatePiano_new(long dummy)		// dummy = int argument typed into object box (A_DEFLONG) -- defaults to 0 if no args are typed
{
	t_rotatePiano* x;
