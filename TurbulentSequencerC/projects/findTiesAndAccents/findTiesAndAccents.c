...
void *findTiesAndAccents_new(long dummy);
...
void ext_main(void *r)
{
	...
	c = class_new("findTiesAndAccents", (method)findTiesAndAccents_new, (method)findTiesAndAccents_free, sizeof(t_findTiesAndAccents), 0L, A_DEFLONG, 0);
...
void *findTiesAndAccents_new(long dummy)		// dummy = int argument typed into object box (A_DEFLONG) -- defaults to 0 if no args are typed
{
