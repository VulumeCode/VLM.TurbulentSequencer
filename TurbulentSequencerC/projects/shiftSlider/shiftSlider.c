...
void *shiftSlider_new(t_symbol* s, short ac, t_atom* av);
...
void ext_main(void *r)
{
	...
	c = class_new("shiftSlider", (method)shiftSlider_new, (method)shiftSlider_free, sizeof(t_shiftSlider), 0L, A_GIMME, 0);
