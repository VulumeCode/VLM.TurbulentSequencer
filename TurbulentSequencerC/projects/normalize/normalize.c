...
void ext_main(void *r)
{
	...
	c = class_new("normalize", (method)normalize_new, (method)normalize_free, sizeof(t_normalize), 0L, A_DEFLONG, 0);
...
void *normalize_new(long dummy)		// dummy = int argument typed into object box (A_DEFLONG) -- defaults to 0 if no args are typed
{
	t_normalize* x;
