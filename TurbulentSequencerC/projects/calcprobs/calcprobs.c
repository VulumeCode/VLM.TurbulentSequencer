...
void ext_main(void *r)
{
	...
	c = class_new("calcprobs", (method)calcprobs_new, (method)calcprobs_free, sizeof(t_calcprobs), 0L, A_DEFLONG, 0);
...
void *calcprobs_new(long dummy)		// dummy = int argument typed into object box (A_DEFLONG) -- defaults to 0 if no args are typed
{
	t_calcprobs* x;
