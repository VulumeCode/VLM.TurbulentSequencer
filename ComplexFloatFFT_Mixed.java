...
public class ComplexFloatFFT_Mixed extends ComplexFloatFFT {
    ...
    void pass_6(int fi, float in[], int in0, int istride, float out[], int out0, int ostride, int sign, int product) {
        ...
        for (k = 0; k < q; k++) {
            ...
            for (k1 = 0; k1 < p_1; k1++) {
                ...
                /*
                 * W(6) is a combination of sums and differences of W(3) acting on the even and
                 * odd elements of z
                 */
    ...
    void pass_n(int fi, float in[], int in0, int istride, float out[], int out0, int ostride, int sign, int factor,
            int product) {
        int i = 0, j = 0;
        int k, k1;
